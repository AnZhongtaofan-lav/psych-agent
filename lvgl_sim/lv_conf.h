...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (2 * 1024 * 1024U)   /*[bytes] 相机 canvas 单帧 153KB, UI+字体再占若干, 2MB 充裕*/
...
/*FreeType library — Windows 模拟器关掉，板子上 main.c 里会重新开启*/
...
#define LV_USE_SDL              0    /* board: no SDL on ARM Linux */
#if LV_USE_SDL
...
/*Driver for /dev/fb*/
#define LV_USE_LINUX_FBDEV      0   /* ⛔ Windows 模拟器用不到 fbdev */
...
#define LV_USE_EVDEV    0   /* ⛔ Windows 模拟器用 SDL mouse/keyboard 代替 */
